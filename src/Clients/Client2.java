...
/**
 *This is client number 1 ,the code for client 1 and 2 seems to be the same and could have been implemented as just
...
public class Client2
{
        ...
        while(true)
        {
            ...
            if(userInput.equals("STARTUP")) {
                ...
                if(!ClientHelper.getMethod(lookupInput).equals("200 OK")) {
                    ...
                    StringBuffer sb = new StringBuffer("src\\ClientFiles\\Client2\\rfc");
                    sb.append(rfcID);
                    sb.append(".txt");
    ...
    public static void main(String [] args) throws IOException {
        new receieveMessage2().start();
        sendMessages();
    }

}
class receieveMessage2 extends Thread{
    ...
    public void run(){
        try {
            ServerSocket serverSocket = new ServerSocket(49156);
            while(true) {
                ...
                sb.append("src\\ClientFiles\\Client2\\rfc");
                sb.append(rfcID);
                sb.append(".txt");
